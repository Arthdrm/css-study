...
->  document.querySelectorAll("selector_css")
    ...
    Kembalian : Mengembalikan Node List.
...
->  document.addEventListener("event", fungsi_callback)
    ...
    objek event akan dilempar sebagai argumen pertama dari fungsi_callback tsb.
...
->  (param1, param2, ...) => {
    ...
    Fungsi anonymous sendiri digunakan utk menulis fungsi yg hanya digunakan utk kasus tertentu (non-utility).
